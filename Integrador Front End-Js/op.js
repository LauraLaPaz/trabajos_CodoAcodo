...
function updateCategory(evento) {
    ...
    switch (categoria) {
        case "estudiante": {
            ...
            document.querySelector(".estudiante").style.backgroundColor = "#5c6bc069";
        ...
        case "trainee": {
            ...
            document.querySelector(".trainee").style.backgroundColor = "#3a903d52";
            document.querySelector(".junior").style.backgroundColor = "transparent";
            break;
        }
        case "junior": {
            ...
            document.querySelector(".estudiante").style.backgroundColor = "transparent";
            document.querySelector(".trainee").style.backgroundColor = "transparent";
            document.querySelector(".junior").style.backgroundColor = "#e3d1c5";
            break;
        }
    }
}
